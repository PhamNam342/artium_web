...
export class CreateUserTable1787034838243 implements MigrationInterface {
  name = 'CreateUserTable1787034838243';

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TYPE "public"."users_role_enum" AS ENUM('ADMIN', 'ARTIST', 'COLECTOR')`,
    );
    await queryRunner.query(
